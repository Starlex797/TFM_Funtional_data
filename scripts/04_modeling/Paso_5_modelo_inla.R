...
write.csv(comparacion, here("outputs", "tables", "comparacion_modelos_dia_tipo.csv"), row.names = FALSE)
...
write.csv(comparacion, here("outputs", "comparacion_modelos.csv"), row.names = FALSE)
