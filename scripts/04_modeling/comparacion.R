...
fwrite(tabla_efectos_fijos,
       here("outputs", "tables", "tabla_efectos_fijos.csv"))
cat("\n✅ Tabla de efectos fijos guardada en outputs/tables/tabla_efectos_fijos.csv\n")
...
fwrite(tabla_comparativa,
       here("outputs", "tables", "tabla_comparativa_modelos.csv"))
cat("\n✅ Tabla comparativa guardada en outputs/tables/tabla_comparativa_modelos.csv\n")
...
fwrite(rbind(resultados_fold_st, resultados_fold_s),
       here("outputs", "tables", "cv_metricas_por_fold.csv"))
cat("✅ Métricas por fold guardadas en outputs/tables/cv_metricas_por_fold.csv\n")
