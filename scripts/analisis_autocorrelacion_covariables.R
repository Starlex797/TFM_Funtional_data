...
carpeta_h <- here("outputs", "analisis_autocorrelacion", "horario")
...
carpeta_d <- here("outputs", "analisis_autocorrelacion", "diario")
...
carpeta_m <- here("outputs", "analisis_autocorrelacion", "mensual")
...
cat("\n   Análisis completado. Resultados en: ", here("outputs", "analisis_autocorrelacion"), "\n\n")
