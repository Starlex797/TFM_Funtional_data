...
png(here("outputs", "figures", "01_no2_histogramas.png"), width = 1000, height = 500, res = 120)
...
png(here("outputs", "figures", "03_no2_nube_variograma.png"), width = 700, height = 500, res = 120)
...
png(here("outputs", "figures", "04_no2_variograma_ajustado.png"), width = 700, height = 500, res = 120)
...
ggsave(here("outputs", "figures", "05_correlacion_covariables_clima.png"),
...
cat("\n✅ Sección 4 completada. Heatmap guardado en outputs/figures/05_correlacion_covariables_clima.png\n")
