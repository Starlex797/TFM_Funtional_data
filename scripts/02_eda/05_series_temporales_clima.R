...
dir_base <- here("outputs", "analysis", "series_temporales_clima")
...
cat(sprintf("\n\u2705 Script completado.\n"))
cat(sprintf("   Diario   : %d PNGs en outputs/analysis/series_temporales_clima/diario/\n", n_d))
cat(sprintf("   Horario  : %d PNGs en outputs/analysis/series_temporales_clima/horario/\n", n_h))
cat(sprintf("   Paneles  : %d PNGs en outputs/analysis/series_temporales_clima/paneles/\n", n_p))
