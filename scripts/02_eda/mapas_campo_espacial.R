...
ggsave(here("outputs", "figures", "mapa1_media_posterior_no2.png"),
       plot = mapa1, width = 7, height = 6, dpi = 300, bg = "white")

ggsave(here("outputs", "figures", "mapa2_incertidumbre_sd.png"),
       plot = mapa2, width = 7, height = 6, dpi = 300, bg = "white")

ggsave(here("outputs", "figures", "mapa3_exceedance_40ugm3.png"),
       plot = mapa3, width = 7, height = 6, dpi = 300, bg = "white")

cat("\n✅ Los tres mapas se han guardado en outputs/figures/\n")
