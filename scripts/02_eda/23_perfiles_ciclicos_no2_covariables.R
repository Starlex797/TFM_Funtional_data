...
# Outputs: outputs/analysis/perfiles_ciclicos/<estacion>/perfil_<ciclo>_<version>.png
# ==============================================================================
...
for (ciclo in names(CICLOS)) {
  ...
  for (estacion in ESTACIONES) {
    ...
    dir_out <- here("outputs", "analysis", "perfiles_ciclicos", slug(estacion))
...
cat("\nListo. Perfiles en outputs/analysis/perfiles_ciclicos/<estacion>/\n")
