...
dir_diario <- here("outputs", "analysis", "scatter_por_estacion", "diario")
dir_horario <- here("outputs", "analysis", "scatter_por_estacion", "horario")
dir.create(dir_diario, recursive = TRUE, showWarnings = FALSE)
dir.create(dir_horario, recursive = TRUE, showWarnings = FALSE)
cat(sprintf(
  "Carpeta de salida: %s\n\n",
  here("outputs", "analysis", "scatter_por_estacion")
))
