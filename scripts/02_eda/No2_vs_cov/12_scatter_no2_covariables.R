...
# Outputs: outputs/analysis/scatter_no2_covariables/diario/ y /horario/
# ==============================================================================
# QUÉ HACE:
#
...
# SALIDAS:
#
# outputs/analysis/scatter_no2_covariables/
#     · diario/
#     · horario/
#
...
dir_d <- here("outputs", "analysis", "scatter_no2_covariables", "diario")
dir_h <- here("outputs", "analysis", "scatter_no2_covariables", "horario")
...
cat(sprintf(
  ...
  here("outputs", "analysis", "scatter_no2_covariables")
))
