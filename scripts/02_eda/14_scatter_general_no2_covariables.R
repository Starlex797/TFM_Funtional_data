...
# Outputs: outputs/analysis/scatter_no2_covariables/general/
# ==============================================================================
# QUÉ HACE:
#
...
# SALIDAS:
#
# outputs/analysis/scatter_no2_covariables/general/
#
...
dir_salida <- here("outputs", "analysis", "scatter_no2_covariables", "general")
