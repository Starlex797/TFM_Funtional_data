...
# Salida: outputs/limitaciones_correlacion/inestabilidad_correlacion.png
# ==============================================================================
...
dir_out <- here("outputs", "limitaciones_correlacion")
dir.create(dir_out, recursive = TRUE, showWarnings = FALSE)
ggsave(file.path(dir_out, "inestabilidad_correlacion.png"),
       fig, width = 14, height = 6.5, dpi = 200, bg = "white")
cat("Guardado: outputs/limitaciones_correlacion/inestabilidad_correlacion.png\n")
