...
# Outputs: outputs/dias_evento/<estacion>/<evento>_<fecha>_{estandarizado,raw}.png
# ==============================================================================
...
for (evento in names(DIAS_EVENTO)) {
  ...
  for (estacion in ESTACIONES) {
    ...
    dir_out <- here("outputs", "dias_evento", slug(estacion))
...
cat("\nListo. Dias-evento en outputs/dias_evento/<estacion>/\n")
