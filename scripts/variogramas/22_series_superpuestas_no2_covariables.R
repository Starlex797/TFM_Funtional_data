...
#
# Outputs: outputs/series_superpuestas/<estacion>/<escala>.png
# ==============================================================================
...
for (esc_nombre in names(ESCALAS)) {
  ...
  for (estacion in ESTACIONES) {
    ...
    dir_out <- here("outputs", "series_superpuestas", slug(estacion))
...
cat("\nListo. Series en outputs/series_superpuestas/<estacion>/\n")
