...
# Outputs: outputs/scatter_no2_covariables/panel_estacion/<estacion>/
# ==============================================================================
...
for (tipo in names(ESTACIONES_TIPO)) {
  ...
  dir_salida <- here("outputs", "scatter_no2_covariables",
...
cat("\nListo. Paneles en outputs/scatter_no2_covariables/panel_estacion/<estacion>/\n")
