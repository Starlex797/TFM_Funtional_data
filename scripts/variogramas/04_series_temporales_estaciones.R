...
# Genera para cada estación:una serie diaria;
# una serie horaria.
...
dir_dias_repr <- here("outputs", "series_temporales", "dias_representativos")
...
cat(sprintf(
  "\n   %d PNGs en outputs/series_temporales/dias_representativos/\n",
