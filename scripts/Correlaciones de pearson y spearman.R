...
DIR_BASE       <- file.path("resultados_julio", "correlacion y scatter plot", "horario")
...
DIR_BASE_DIARIO <- file.path("resultados_julio", "correlacion y scatter plot", "diario")
...
DIR_BASE_MENSUAL <- file.path("resultados_julio", "correlacion y scatter plot", "mensual")
